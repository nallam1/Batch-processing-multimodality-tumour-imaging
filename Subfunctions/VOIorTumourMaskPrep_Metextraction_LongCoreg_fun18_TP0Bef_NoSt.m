...
if Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==1 || Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==2                                          
                                ...
                                %                            countReorientationAtmt3=0;
                                                        ...
                                                        if BinVesselsAlreadyPrepared==1    
                                                            ...
                                                            if glass_1_Tissue_2_both_3_contour==1
                                                                nexttile 
                                                                    h1=imshowpair(squeeze(sum(mask_3D_Unrestricted_FromTopContour,2)),squeeze(sum(RawOCTA,2)));
                                                                    title('Sagital (yz) plane')
                                                                nexttile
                                                                    h2=imshowpair(squeeze(sum(mask_3D_Unrestricted_FromTopContour,3)),squeeze(sum(RawOCTA,3)));
                                                                    title('Coronal (xz) plane')
                                                                nexttile
                                                                    h3=imshowpair(squeeze(sum(mask_3D_Unrestricted_FromTopContour,1)),squeeze(sum(RawOCTA,1)));
                                                                    title('Transverse (xy) plane')

                                                                    title(t,{[MouseTimepoint]; ['Overlay of binarized vessels and tumour mask']})
                                                                    f.WindowState='maximize';
                                                                    figure, imshow3D(cat(2,mask_3D_Unrestricted_FromTopContour-RawOCTA,RawOCTA))
                                                            else
                                                                nexttile 
...
%                                                             end
                                                    ...
                                                    elseif glass_1_Tissue_2_both_3_contour==1 
                                                        save(SaveFilenameDataUnlimited{1},'mask_3D_Unrestricted_FromTopContour','-mat','-v7.3');
