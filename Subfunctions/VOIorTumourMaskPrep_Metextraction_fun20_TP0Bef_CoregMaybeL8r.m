...
%% 8) Identification of bottom surface of glass interface(s)
%             if Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==0 || Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==2
...
%% 9) Coregistration in depth pre contouring in depth of tissue
%Helps in labeling tissue at every timepoint
if Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==1 || Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==2
    if glass_1_Tissue_2_both_3_contour==1||glass_1_Tissue_2_both_3_contour==3
    ...
    if Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==1 || Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==2
        ...
        if glass_1_Tissue_2_both_3_contour==1 ||glass_1_Tissue_2_both_3_contour==3
            ...
            if glass_1_Tissue_2_both_3_contour==1
                ...
                mask_3D_Unrestricted_FromTopContour=logical(imwarp(imwarp(mask_3DGlass,transform3DLateral_OCT_Time0Pre{1}),transform3DLateral_OCT_Time0Pre{2},'OutputView',R3Dfixed,'interp','cubic')) & tumor_maskProj3DRot;%mask_3D_Top & %flip(mask_3D_Top & tumor_maskProj3DRot,3);
...
Fix code to have contouring of glass only used in step 10) then before step 11 have glass removed used and reference timepoint 0 view (with maybe contour shown?) used)

%% 11) Contouring of tissue interface now that it is coregistered to timepoint 0- in depth and laterally
    ...
    if VisualizeResults==1
        ...
        if glass_1_Tissue_2_both_3_contour==1
            if BinVesselsAlreadyPrepared==1
                ...
                RawOCTAVarname=whos('-file',fullfile(saveFolder{1},'RawVess_CoregTime0-_RotShift.mat'));
