...
% if glass_1_Tissue_2_both_3_contour~=1 
    ...
    if Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==0 || Mask2DandMetsOnly_0_OR_Mask3DOnlyAfter_1_OR_AllAtOnce_2==2
        ...
        load(fullfile(OptFluSegmentationFolder,[PrefixFLU_BRI_Var,'TumourMask2D_aligned.mat'])); %previously if select alligned coreg TPo- just skips alignment steps above
        %end
